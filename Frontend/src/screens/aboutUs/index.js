    ...
    <ScrollView style={styles.container}>
      <View style={styles.viewStyle}>
        <Text style={styles.textStyle}>
          Tras.h2O is a one stop solution for getting to know the refill
          stations that are avaible nearby as well as recording the data of the
          usage and frequency of the refilling ,For each activity perfomred few
          points are added into the users account which could be used to redeem
          for a coupon from the ones that are availble.
        </Text>
        <Text style={styles.text2Style}>
          Tras.h2O's objective is to provide a platform and service that could
          contribute to the reusability of containers as well as motivate users
          to go green as well as encourage others to join in.
        </Text>
